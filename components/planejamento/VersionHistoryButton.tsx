    ...
    <>
      ...
      {open && (
        <>
          ...
          <aside
            role="dialog"
            className="fixed right-0 top-0 z-50 flex h-full w-full max-w-3xl flex-col border-l border-gray-200 bg-white shadow-xl"
          >
            ...
            <div className="flex items-center gap-2 border-b border-gray-100 bg-gray-50 px-5 py-3">
              <input
                ...
                className="flex-1 rounded-md border border-gray-200 px-3 py-1.5 text-sm focus:border-brand-600 focus:outline-none"
                maxLength={200}
              />
              <button
            ...
            <div className="flex flex-1 overflow-hidden">
              <aside className="w-56 shrink-0 border-r border-gray-100 bg-gray-50">
                {loading && (
...
function authorIcon(k: string) {
  switch (k) {
    ...
    case "ai":
      return <Bot className="h-3 w-3 text-violet-700" />;
    case "system":
    default:
  ...
  return (
    <div className="space-y-4">
      ...
      {diff.sections
        ...
        .map((s) => (
          <section key={s.sectionKey} className="rounded-lg border border-gray-200">
