  ...
  return (
    <div className="mb-6 bg-gradient-to-br from-brand-50 via-white to-indigo-50 rounded-2xl border-2 border-brand-200 p-5 relative overflow-hidden">
      ...
      <div className="relative z-10">
        ...
        <button
          onClick={dismiss}
          className="mt-4 w-full flex items-center justify-center gap-2 px-4 py-2 bg-gradient-to-r from-brand-700 to-indigo-600 text-white font-semibold text-sm rounded-xl hover:from-brand-800 hover:to-indigo-700 transition-all"
        >
