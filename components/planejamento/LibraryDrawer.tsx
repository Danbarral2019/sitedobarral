          ...
          {creating && (
            <div className="mt-3 rounded-md border border-brand-100 bg-white p-3">
              <input
                ...
                placeholder="Título"
                className="mb-2 w-full rounded-md border border-gray-200 px-3 py-1.5 text-sm"
                maxLength={200}
              />
              <textarea
                value={formCorpo}
                ...
                rows={6}
                className="w-full resize-none rounded-md border border-gray-200 px-3 py-2 font-mono text-xs"
                maxLength={20000}
              />
