...
export default function WelcomeModal() {
  ...
  return (
    <>
      ...
      {isOpen && (
        <div
          className="hidden sm:block fixed inset-0 bg-black/60 backdrop-blur-sm z-50 transition-opacity duration-300"
          onClick={handleClose}
        />
      )}

      {/* Modal - Apenas Desktop */}
      {isOpen && (
        <div className="hidden sm:flex fixed inset-0 z-50 items-center justify-center p-4 pointer-events-none overflow-y-auto">
          <div
          ...
          >
            ...
            <div className="relative bg-gradient-to-r from-blue-600 to-blue-700 p-8 rounded-t-2xl">
              ...
              <div className="text-center">
                ...
                <h2 id="welcome-title" className="text-3xl font-bold text-white mb-2 leading-tight">
