          ...
          <div className="ml-3 flex-1">
            ...
            <div className="mt-3 flex flex-col sm:flex-row gap-2">
              <Link
                ...
                className="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md text-surface-page bg-red-600 hover:bg-semantic-error focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500"
              >
                Renovar Acesso
              </Link>
              <Link
        ...
        <div className="flex items-start">
          ...
          <div className="ml-3 flex-1">
            ...
            <div className="mt-3 flex flex-col sm:flex-row gap-2">
              <Link
                href={`/upgrade/${courseId}`}
                className="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md text-surface-page bg-yellow-600 hover:bg-yellow-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-yellow-500"
              >
