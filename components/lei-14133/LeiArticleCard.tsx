      ...
      <div className="flex items-start justify-between mb-4">
        <div>
          <div className="flex items-center gap-3 mb-2 flex-wrap">
            <span className="px-4 py-2 bg-brand-600 text-white font-bold rounded-[6px]">
              Artigo {numero}
            </span>
            <span
          ...
          {titulo && <p className="text-sm text-ink-muted mb-1">{titulo}</p>}
          {capituloCompleto && <p className="text-sm text-ink-muted mb-2">{capituloCompleto}</p>}
        </div>
        <div className="text-right flex-shrink-0">
          <p className="text-2xl font-bold text-brand-600">{documentCount}</p>
          <p className="text-sm text-ink-muted">documentos</p>
        </div>
      </div>
