...
export function LegislativeActResultCard({ act, query }: LegislativeActResultCardProps) {
 ...
 <div className="p-2 rounded-[3px] bg-surface-raised text-amber-accent flex-shrink-0">
 ...
 <span className="px-2 py-0.5 rounded-full text-xs font-medium bg-amber-accent-soft text-amber-accent-deep">
 ...
 <span className="px-2 py-0.5 rounded-full text-xs font-medium bg-surface-raised text-brand-700">
