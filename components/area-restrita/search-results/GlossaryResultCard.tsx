...
export function GlossaryResultCard({ term, query }: GlossaryResultCardProps) {
  ...
  return (
    <div className="bg-white rounded-[6px] border border-border-subtle p-4 hover:border-green-300 hover: transition-all">
      <div className="flex items-start gap-3">
        <div className="p-2 rounded-[6px] bg-green-50 text-green-600 flex-shrink-0">
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-center justify-between">
            <Link
              ...
              className="font-semibold text-ink-primary text-sm hover:text-green-600 transition-colors"
            >
