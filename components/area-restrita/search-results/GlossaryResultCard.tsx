...
export function GlossaryResultCard({ term, query }: GlossaryResultCardProps) {
  ...
  return (
    <div className="bg-[var(--bg-card)] rounded-xl border border-[var(--border-default)] p-4 hover:border-green-300 hover:shadow-md transition-all">
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-center justify-between">
            <Link
              ...
              className="font-semibold text-[var(--text-primary)] text-sm hover:text-green-600 transition-colors"
            >
