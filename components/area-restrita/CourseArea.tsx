...
export default function CourseArea({
 ...
 : 'border-border-subtle bg-surface-page hover:border-brand-300 hover:shadow-sm'
 }`}
 >
 <div className="flex items-center gap-3">
 <div
 className={`p-2 rounded-[3px] ${isActive ? 'bg-brand-100' : 'bg-surface-deep'}`}
 >
 <GraduationCap
 ...
 <h3
 className={`text-sm font-bold line-clamp-1 ${isActive ? 'text-brand-900' : 'text-ink-primary'}`}
 >
 ...
 <div className="px-5 py-4 bg-surface-raised border-t border-border-subtle">
 <div className="flex flex-col sm:flex-row sm:items-center gap-3 sm:gap-4">
 <div className="flex items-center gap-3 flex-1 min-w-0">
 <div className="p-2 bg-brand-100 rounded-[3px] flex-shrink-0">
 ...
 className="flex items-center justify-center gap-2 px-5 py-2.5 bg-brand-600 text-surface-page rounded-md font-semibold text-sm hover:bg-brand-800 transition-colors flex-shrink-0"
 >
 Entrar no Curso
 ...
 <div
 className="w-8 h-8 rounded-[3px] flex items-center justify-center flex-shrink-0"
 style={{ backgroundColor: section.accent + '12' }}
 >
 <Icon className="w-4 h-4" style={{ color: section.accent }} />
 </div>
 <h3 className="text-sm font-bold text-ink-primary">{section.title}</h3>
 <span
 ...
 className="w-full text-left bg-surface-raised hover:bg-surface-deep rounded-md p-3.5 transition-all group/card flex items-center gap-3"
 >
 <div
 ...
 <span className="text-[10px] font-semibold uppercase tracking-wider px-1.5 py-0.5 rounded bg-surface-page text-ink-muted flex-shrink-0">
 {getDocTypeLabel(doc.type)}
 </span>
 <ChevronRight className="w-4 h-4 text-border-strong group-hover/card:text-brand-500 flex-shrink-0 transition-colors" />
 </button>
 ))}
 </div>
 </div>
 ...
 <p className="text-sm font-medium text-ink-secondary">Conteúdo em preparação</p>
