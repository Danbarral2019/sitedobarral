...
export default function FeedbackTipBanner() {
 ...
 <div
 role="status"
 className="mb-4 flex items-start gap-3 rounded-[3px] border border-border-subtle bg-surface-raised px-4 py-3 text-sm text-amber-accent-deep"
 >
 <div className="flex-shrink-0 pt-0.5" aria-hidden="true"> </div>
 ...
 className="flex-shrink-0 rounded p-1 text-amber-accent-deep transition-colors hover:bg-amber-accent-soft hover:text-amber-accent-deep"
 >
 <X className="h-4 w-4" />
 </button>
 </div>
