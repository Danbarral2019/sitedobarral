...
export function WelcomeBanner() {
  ...
  return (
    <div className="bg-brand-50 border border-brand-200 rounded-[6px] px-4 py-3 flex items-center gap-3">
      ...
      <button
        onClick={dismiss}
        className="p-1 text-brand-400 hover:text-brand-600 hover:bg-brand-100 rounded-[6px] transition-colors flex-shrink-0"
        aria-label="Fechar"
      >
        <X className="w-4 h-4" />
      </button>
