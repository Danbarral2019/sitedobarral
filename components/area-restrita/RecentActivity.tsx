...
export default function RecentActivity({ onDocumentClick }: RecentActivityProps) {
 ...
 className="flex-shrink-0 w-56 bg-surface-page border border-border-subtle rounded-md p-3 text-left hover:border-brand-300 hover:shadow-sm transition-all group"
 >
