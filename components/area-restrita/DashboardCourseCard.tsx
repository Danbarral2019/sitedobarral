...
export function DashboardCourseCard({
 ...
 return (
 <div key={courseId} className="bg-surface-page border border-border-subtle rounded-md overflow-hidden">
 {/* Course Header */}
 <div className="p-5">
 <div className="flex items-start gap-3">
 <div className="p-2.5 bg-brand-100 rounded-md flex-shrink-0">
 ...
 className="flex items-center gap-1.5 px-4 py-2 bg-brand-600 text-surface-page rounded-md font-semibold text-sm hover:bg-brand-800 transition-colors flex-shrink-0"
 >
 Entrar
 ...
 className="w-full flex items-center gap-2 px-5 py-3 text-sm font-medium text-ink-secondary hover:text-ink-primary hover:bg-surface-raised transition-colors"
 >
 <ChevronDown
 ...
 className="w-full text-left bg-surface-raised hover:bg-surface-deep rounded-md p-3.5 transition-all group flex items-center gap-3"
 >
 ...
 <Clock className="w-5 h-5 text-border-strong mx-auto mb-2" />
