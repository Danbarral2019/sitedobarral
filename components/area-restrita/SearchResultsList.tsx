  ...
  if (isLoading && !showAiCard) {
    return (
      <div className="space-y-4">
        {[1, 2, 3].map((i) => (
          <div key={i} className="bg-[var(--bg-card)] rounded-xl border border-[var(--border-default)] p-4 animate-pulse">
          ...
          return (
            <div key={type}>
              ...
              <div className="flex items-center gap-2 mb-3">
                ...
                <h3 className="font-bold text-[var(--text-primary)]">{config.labelPlural}</h3>
