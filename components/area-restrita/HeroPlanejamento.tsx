...
export function HeroPlanejamento() {
  ...
  return (
    <section className="relative mb-6 overflow-hidden rounded-[6px] bg-brand-700 p-6 text-white lg:p-8 border border-border-subtle">
        ...
        <div className="flex-1">
          ...
          <div className="mt-5 flex flex-col gap-2 sm:flex-row sm:flex-wrap sm:gap-3">
            <Link
              ...
              className="inline-flex items-center justify-center gap-2 rounded-[6px] bg-white px-5 py-2.5 text-sm font-semibold text-brand-800 transition hover:bg-brand-50 border border-border-subtle"
            >
            ...
            {count !== null && count > 0 && (
              <Link
                ...
                className="inline-flex items-center justify-center gap-2 rounded-[6px] border border-white/30 bg-white/10 px-5 py-2.5 text-sm font-medium text-white transition hover:bg-white/20"
              >
