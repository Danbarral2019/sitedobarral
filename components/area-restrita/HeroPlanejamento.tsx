...
export function HeroPlanejamento() {
 ...
 return (
 <section className="relative mb-6 overflow-hidden rounded-md bg-surface-raised p-6 text-ink-primary lg:p-8">
 <div className="pointer-events-none absolute -right-12 -top-12 h-48 w-48 rounded-full bg-surface-page/10 blur-2xl" />
 <div className="pointer-events-none absolute -right-20 bottom-0 h-64 w-64 rounded-full bg-surface-page/5 blur-3xl" />
 ...
 <h2 className="font-serif text-2xl leading-tight text-surface-page lg:text-3xl">
 Elabore ETP, TR e matriz de decisão
 </h2>
 <p className="mt-2 max-w-xl text-sm leading-relaxed text-surface-page/90 lg:text-base">
 ...
 className="inline-flex items-center justify-center gap-2 rounded-[3px] bg-surface-page px-5 py-2.5 text-sm font-semibold text-brand-800 transition hover:bg-brand-50"
 >
 ...
 className="inline-flex items-center justify-center gap-2 rounded-[3px] border border-border-subtle bg-surface-deep px-5 py-2.5 text-sm font-medium text-ink-secondary transition hover:bg-surface-deep"
 >
