...
export function LegislacaoFiltersPanel({
  ...
  return (
    <div className="bg-white border-2 border-border-subtle rounded-[6px] p-6 space-y-4">
      ...
      {hasActiveFilters && (
        <button
          onClick={onClear}
          className="flex items-center gap-2 px-4 py-2 text-sm text-ink-secondary hover:text-ink-primary hover:bg-surface-deep rounded-[6px] transition-colors"
        >
          <X className="w-4 h-4" />
