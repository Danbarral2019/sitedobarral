  ...
  return (
    <div className="mt-12 flex justify-center items-center gap-2">
      <button
        ...
        disabled={page === 1}
        className="px-6 py-3 border border-border-strong rounded-[3px] font-semibold disabled:opacity-50 disabled:cursor-not-allowed hover:bg-surface-raised transition-colors"
      >
        ← Anterior
      </button>
