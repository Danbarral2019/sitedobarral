...
export default function HighlightedMaterials({
  ...
  return (
    <div className="bg-gradient-to-br from-amber-50 to-orange-50 rounded-2xl shadow-lg p-6 lg:p-8 mb-6 border-2 border-amber-200">
      <div className="mb-6">
        <h2 className="text-xl lg:text-2xl font-bold text-gray-900 mb-2">📚 Materiais Essenciais</h2>
        <p className="text-base lg:text-lg text-gray-700">Documentos fundamentais para acompanhamento do curso</p>
      </div>
      ...
      {/* Info adicional */}
      <div className="mt-4 p-4 lg:p-4 bg-amber-100 border border-amber-300 rounded-lg">
        <p className="text-sm lg:text-sm text-amber-900 font-medium leading-relaxed">
