...
export default function CourseSuspensionBanner({
  ...
  return (
    <div className="rounded-[6px] border border-amber-accent bg-amber-accent-soft p-5 lg:p-6 mb-6">
      <div className="flex items-start gap-3">
        <div className="p-2 bg-amber-accent-soft rounded-[6px] flex-shrink-0">
