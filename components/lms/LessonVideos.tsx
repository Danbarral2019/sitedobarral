...
export default function LessonVideos({ videos }: LessonVideosProps) {
 ...
 {videos.map((video) => (
 <div key={video.id} className="bg-surface-page border border-border-subtle rounded-md overflow-hidden">
 ...
 <div className="w-14 h-14 rounded-full bg-surface-page/90 flex items-center justify-center group-hover:scale-110 transition-transform">
