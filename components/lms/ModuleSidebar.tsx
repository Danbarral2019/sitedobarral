...
export default function ModuleSidebar({
 ...
 return (
 <div className="bg-surface-page border border-border-subtle rounded-md overflow-hidden flex flex-col h-full">
 {/* Header */}
 ...
 <p className="text-xs font-bold text-ink-primary line-clamp-1">{mod.title}</p>
 ...
 <div
 key={lesson.id}
 className="flex items-center gap-2.5 px-4 py-2 mx-2 rounded-[3px] opacity-50 cursor-not-allowed"
 ...
 className={`flex items-center gap-2.5 px-4 py-2 mx-2 rounded-[3px] text-left transition-colors ${
 isCurrent
 ...
 {isCompleted ? (
 <CheckCircle className="w-4 h-4 text-ink-secondary" />
 ) : isCurrent ? (
