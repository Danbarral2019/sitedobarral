...
export default async function FAQPage({
  ...
  return (
    <main className="min-h-screen bg-surface-raised">
      <section className="bg-surface-raised text-ink-primary py-16 border-b border-border-subtle">
      ...
      <section className="container mx-auto px-4 max-w-4xl py-8">
          ...
          <div className="space-y-8">
            {groups.map((group) => (
              <section key={group.category}>
                <h2 className="text-2xl font-bold text-ink-primary mb-4 pb-2 border-b-2 border-border-subtle">
                  {group.category}
        ...
        <div className="mt-12 text-center bg-surface-raised border border-border-subtle rounded-md p-6">
