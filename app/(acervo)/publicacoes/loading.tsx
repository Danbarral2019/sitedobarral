    ...
    <div className="container mx-auto px-4 py-12">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mb-12 animate-pulse">
          <div className="h-12 bg-surface-deep rounded-[6px] w-80 mb-4"></div>
        ...
        <div className="flex gap-4 mb-8 animate-pulse">
          {[1, 2, 3, 4].map((i) => (
            <div key={i} className="h-10 bg-surface-deep rounded-[6px] w-32"></div>
          ))}
        </div>
        ...
        <div className="space-y-6">
          {[1, 2, 3].map((i) => (
            <div key={i} className="bg-white rounded-[6px] p-6 animate-pulse border border-border-subtle">
