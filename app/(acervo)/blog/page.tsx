        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-8">
            {publishedPosts.map((post, index: number) => {
              ...
              return (
                <article key={post.id} className={`bg-white rounded-[6px] overflow-hidden hover: transition-all border-l-4 ${borderColor} hover:scale-[1.01]`}>
                  <div className="p-8">
                  ...
                  <div className="flex flex-wrap items-center gap-4 text-sm text-ink-secondary font-medium mb-4">
                  ...
                  <p className="text-ink-secondary mb-4 line-clamp-3 leading-relaxed">
                    {post.excerpt}
                  </p>

                  <Link
                    href={`/blog/${post.slug}`}
                    className="inline-flex items-center gap-2 text-white bg-brand-700 px-6 py-3 rounded-[6px] font-bold hover:from-brand-700 hover:to-brand-800 transition-all hover: border border-border-subtle"
                  >
                    Ler artigo completo
          ...
          {publishedPosts.length === 0 && (
            <div className="text-center py-12">
              <p className="text-ink-muted">Nenhum artigo publicado ainda.</p>
            </div>
          )}

          <div className="mt-12 relative overflow-hidden bg-green-600 rounded-[6px] p-10 md:p-12 text-center border-4 border-green-400">
