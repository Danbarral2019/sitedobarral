    ...
    <main className="py-12">
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <article className="bg-white rounded-[6px] p-8 border border-border-subtle">
            <header className="mb-8">
              ...
              <div className="flex flex-wrap items-center gap-4 text-sm text-ink-muted pb-6 border-b">
              ...
              <div className="grid md:grid-cols-3 gap-6">
                {relatedPosts.map((relatedPost) => (
                  <Link
                    ...
                    className="bg-white rounded-[6px] p-6 hover: transition-shadow border border-border-subtle"
                  >
                    <h3 className="font-semibold mb-2 line-clamp-2">{relatedPost.title}</h3>
                    <p className="text-sm text-ink-muted line-clamp-3">{relatedPost.excerpt}</p>
          ...
          {process.env.COMING_SOON_ENABLED !== 'true' && (
            <div className="mt-12 bg-primary-50 rounded-[6px] p-8 text-center">
              ...
              <form className="flex flex-col sm:flex-row gap-4 max-w-md mx-auto">
                <input
                  ...
                  className="flex-1 px-4 py-3 rounded-[6px] border border-border-subtle focus:outline-none focus:border-primary-500"
                />
                <button
                  type="submit"
                  className="bg-primary-600 text-white px-6 py-3 rounded-[6px] font-semibold hover:bg-primary-700 transition-colors"
                >
                  Cadastrar
                </button>
              </form>
