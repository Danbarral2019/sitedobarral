  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        alert(`Erro ao criar termo: ${data.error || 'Erro desconhecido'}`);
      }
    } catch (error) {
      ...
      <div className="p-6 md:p-8 max-w-5xl mx-auto">
        <div className="mb-8">
          <div className="flex items-center gap-3 mb-2">
            ...
            <div>
              <h1 className="text-3xl font-bold text-gray-900">Novo Termo do Glossário</h1>
              <p className="text-gray-600">Criar novo termo jurídico</p>
            </div>
          </div>
        </div>
