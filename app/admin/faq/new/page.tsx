...
export default function NewFAQPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        alert(`Erro ao criar FAQ: ${data.error || 'Erro desconhecido'}`);
      }
    } catch (error) {
  ...
  const renderMarkdownPreview = (text: string) => {
    // Simples renderização de Markdown para preview
    return text
      .split('\n')
      .map((line, idx) => {
        // Headers
      ...
      <div className="p-6 md:p-8 max-w-5xl mx-auto">
        ...
        <div className="mb-8">
          <div className="flex items-center gap-3 mb-2">
            ...
            <div>
              <h1 className="text-3xl font-bold text-gray-900">Nova FAQ</h1>
              <p className="text-gray-600">Criar nova pergunta frequente</p>
            </div>
          </div>
        </div>
            ...
            <label className="block mb-2">
              ...
              {showPreview ? (
                ...
                <textarea
                  ...
                  placeholder="Digite a resposta em Markdown...&#10;&#10;Dica: Use **negrito**, [links](url), listas com -, etc."
                  rows={12}
