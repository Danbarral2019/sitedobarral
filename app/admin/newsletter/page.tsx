                    ...
                    <tr key={subscriber.id} className="hover:bg-gray-50 transition-colors">
                      ...
                      <td className="px-6 py-4">
                        <span className="text-sm text-gray-700">
                          {subscriber.name || <span className="text-gray-400 italic">Não informado</span>}
                        </span>
                      </td>
                      <td className="px-6 py-4">
                        <div className="flex flex-wrap gap-1">
                          {parseInterests(subscriber.interests).length > 0 ? (
                            parseInterests(subscriber.interests).map((interest, idx) => (
                              <span
                                key={idx}
