...
export default function MeuProgressoPage() {
 ...
 <p className="text-ink-secondary">Carregando progresso...</p>
 </div>
 </div>
 );
 }
 ...
 <div className="bg-surface-page rounded-md p-5 border border-border-subtle">
 <div className="flex items-center gap-3 mb-2">
 <div className="w-10 h-10 bg-amber-accent-soft rounded-[3px] flex items-center justify-center">
 ...
 <div className="bg-surface-page rounded-md p-5 border border-border-subtle">
 <div className="flex items-center gap-3 mb-2">
 <div className="w-10 h-10 bg-surface-deep rounded-[3px] flex items-center justify-center">
 <Flame className="w-5 h-5 text-ink-secondary" />
 </div>
 ...
 <div className="flex items-center gap-3 mb-2">
 <div className="w-10 h-10 bg-surface-deep rounded-[3px] flex items-center justify-center">
 <Trophy className="w-5 h-5 text-ink-secondary" />
 </div>
 ...
 <div
 key={cp.courseId}
 className="bg-surface-page rounded-md p-6 border border-border-subtle"
 >
 ...
 <div
 className="bg-surface-raised h-3 rounded-full transition-all duration-500"
 ...
 <div className="bg-surface-page rounded-md p-6 border border-border-subtle text-center">
 <Award className="w-12 h-12 text-border-strong mx-auto mb-3" />
 ...
 <div
 key={badge.id}
 className="bg-surface-page rounded-md p-4 border border-border-subtle flex items-center gap-4"
 >
 ...
 <div>
 <h2 className="text-xl font-bold text-ink-primary mb-4 flex items-center gap-2">
 <Target className="w-5 h-5 text-ink-secondary" />
 Atividades Recentes
 </h2>
 ...
 <div
 key={cert.id}
 className="bg-surface-raised rounded-md p-4 border border-border-subtle flex items-center gap-4"
 >
 <div className="w-10 h-10 bg-surface-deep rounded-[3px] flex items-center justify-center flex-shrink-0">
 <Award className="w-5 h-5 text-ink-secondary" />
 </div>
 <div className="flex-1 min-w-0">
 <p className="font-bold text-ink-primary">{cert.courseTitle}</p>
 <p className="text-sm text-ink-secondary font-mono">{cert.certificateNumber}</p>
 <p className="text-xs text-ink-muted mt-1">
