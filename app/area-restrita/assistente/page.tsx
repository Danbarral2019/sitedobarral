...
export default async function AssistentePage() {
 ...
 <Link
 href="/area-restrita"
 className="inline-flex items-center gap-2 text-brand-600 hover:text-ink-primary mb-4 transition-colors text-sm font-medium"
 >
 ...
 <div className="flex items-start gap-3 p-4 bg-surface-raised rounded-[3px]">
 ...
 <div className="flex items-start gap-3 p-4 bg-surface-raised rounded-[3px]">
 <MessageSquare className="w-5 h-5 text-ink-secondary flex-shrink-0 mt-0.5" />
 <div>
 <h3 className="font-semibold text-ink-primary text-sm">
 Citações de Fontes
 </h3>
 ...
 <div className="flex items-start gap-3 p-4 bg-surface-raised rounded-[3px]">
 <Zap className="w-5 h-5 text-ink-secondary flex-shrink-0 mt-0.5" />
 <div>
 <h3 className="font-semibold text-ink-primary text-sm">
 ...
 <div className="bg-surface-raised rounded-md p-6 border border-border-subtle">
