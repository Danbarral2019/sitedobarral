...
function statusBadge(status: string): { label: string; className: string } {
 ...
 active: { label: 'Ativa', className: 'bg-surface-deep text-ink-primary' },
 past_due: { label: 'Pagamento pendente', className: 'bg-amber-accent-soft text-amber-accent-deep' },
 processing: { label: 'Em processamento', className: 'bg-surface-deep text-ink-primary' },
 canceled: { label: 'Cancelada', className: 'bg-surface-deep text-ink-secondary' },
 unpaid: { label: 'Não paga', className: 'bg-surface-deep text-semantic-error' },
...
export default function MeuPlanoClient({ subscription, enrollments }: Props) {
 ...
 <div className="bg-surface-raised rounded-[3px] p-4">
 ...
 className="inline-flex items-center gap-2 px-5 py-2.5 bg-brand-600 text-surface-page font-medium rounded-[3px] hover:bg-brand-800 transition-colors"
 >
 ...
 <Link
 href="/planos"
 className="inline-flex items-center gap-2 px-5 py-2.5 border border-border-strong text-ink-secondary font-medium rounded-[3px] hover:bg-surface-raised transition-colors"
 >
 Ver outros planos
 </Link>
 </div>
 ...
 <section className="bg-surface-raised border border-border-subtle rounded-md p-6 mb-6">
 <div className="flex items-start gap-4">
 <div className="p-2 bg-surface-page rounded-[3px] shrink-0">
 ...
 <section className="bg-surface-page rounded-md border border-border-subtle p-6">
 ...
 <li
 key={e.id}
 className="flex flex-wrap items-center justify-between gap-3 p-3 rounded-[3px] border border-border-subtle hover:border-border-subtle hover:bg-surface-raised transition-colors"
 >
 <div>
