...
export default async function PlanejamentoListPage() {
 ...
 className="inline-flex items-center gap-2 rounded-[3px] bg-brand-700 px-4 py-2.5 text-sm font-medium text-surface-page hover:bg-brand-800"
 >
 ...
 {sessions.length === 0 ? (
 <div className="rounded-md border-2 border-dashed border-border-subtle p-12 text-center">
 ...
 <Link
 href="/area-restrita/planejamento/nova"
 className="inline-flex items-center gap-2 rounded-[3px] bg-brand-700 px-5 py-2.5 text-sm font-medium text-surface-page hover:bg-brand-800"
 >
 <Plus className="h-4 w-4" />
 ...
 className="block rounded-md border border-border-subtle p-5 transition hover:border-brand-600 hover:shadow-sm"
 >
