...
export default async function PlanejamentoSessaoPage({
 ...
 className="inline-flex items-center gap-2 rounded-[3px] border border-brand-200 bg-surface-page px-4 py-2 text-sm font-medium text-brand-800 hover:border-brand-400"
 >
