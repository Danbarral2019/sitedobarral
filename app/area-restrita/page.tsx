 ...
 */}
 ...
 {/* Important Notice */}
 <div className="bg-surface-raised border-l-4 border-brand-600 p-4 lg:p-6 rounded-r-xl">
 <h3 className="text-base font-bold text-ink-primary mb-1">Importante</h3>
 ...
 className="flex items-center gap-2 text-sm font-medium text-ink-secondary hover:text-brand-600 mb-4 transition-colors"
 >
