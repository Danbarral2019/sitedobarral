...
export default function LessonPage({
 ...
 {/* Top Navigation Bar */}
 <header className="bg-surface-page border-b border-border-subtle sticky top-0 z-30">
 ...
 className="lg:hidden p-2 rounded-[3px] text-ink-muted hover:bg-surface-deep transition-colors"
 >
 ...
 <div className="absolute left-0 top-0 bottom-0 w-[300px] bg-surface-page overflow-y-auto">
 <div className="flex items-center justify-between px-4 py-3 border-b border-border-subtle">
 <h3 className="font-bold text-sm text-ink-primary">Navegacao</h3>
 <button
 onClick={() => setSidebarOpen(false)}
 className="p-1.5 rounded-[3px] hover:bg-surface-deep"
 >
 <X className="w-4 h-4" />
 </button>
 </div>
 ...
 className="flex-1 flex items-center gap-3 bg-surface-page border border-border-subtle rounded-md p-4 hover:border-brand-300 hover:shadow-sm transition-all group"
 >
 <ChevronLeft className="w-5 h-5 text-border-strong group-hover:text-brand-500 flex-shrink-0" />
 ...
 className="flex-1 flex items-center justify-end gap-3 bg-surface-page border border-border-subtle rounded-md p-4 hover:border-brand-300 hover:shadow-sm transition-all group text-right cursor-pointer"
 >
 <div className="min-w-0">
 ...
 <ChevronRight className="w-5 h-5 text-border-strong group-hover:text-brand-500 flex-shrink-0" />
 </button>
 ) : (
 <div className="flex-1" />
 )}
