...
export default function CourseLandingPage({
 ...
 <Link
 href="/area-restrita"
 className="p-2 rounded-[3px] text-ink-muted hover:text-brand-600 hover:bg-brand-50 transition-colors"
 title="Voltar"
 >
 ...
 <span
 key={m.threshold}
 className="inline-flex items-center gap-1 text-xs font-semibold bg-surface-raised text-amber-accent-deep border border-border-subtle px-2 py-1 rounded-full animate-[scale-in_0.3s_ease-out]"
 >
 <span>{m.emoji}</span>
 {m.label}
 </span>
 ...
 className="inline-flex items-center justify-center gap-2 w-full sm:w-auto px-6 py-3 bg-brand-600 text-surface-page rounded-md font-semibold text-sm hover:bg-brand-800 transition-colors"
 >
 ...
 <div
 key={mod.id}
 className="bg-surface-page rounded-md border border-border-subtle overflow-hidden"
 >
 {/* Module Header */}
 ...
 {isModuleComplete ? (
 <span className="flex items-center gap-1 text-xs font-semibold text-ink-secondary bg-surface-raised px-2.5 py-1 rounded-full">
 ...
 <span className="flex items-center gap-1 text-xs text-border-strong mt-0.5">
 ...
 {isCompleted ? (
 <CheckCircle className="w-5 h-5 text-ink-secondary" />
 ) : isInProgress || isContinueTarget ? (
 <Play className="w-5 h-5 text-brand-600" />
 ) : (
 <div className="w-5 h-5 rounded-full border border-border-strong" />
 )}
 </div>
 ...
 {/* Arrow */}
 <ChevronRight className="w-4 h-4 text-border-strong group-hover:text-brand-500 flex-shrink-0 transition-colors" />
 </Link>
 );
 })}
 </div>
 ...
 <BookOpen className="w-10 h-10 text-border-strong mx-auto mb-3" />
