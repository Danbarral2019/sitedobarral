...
export const metadata: Metadata = {
  ...
  description: 'Decisoes de Tribunais de Contas e Judiciais sobre licitacoes e contratos administrativos (Lei 14.133/2021).',
  openGraph: {
    title: 'Jurisprudencia sobre Licitacoes',
    description: 'Decisoes de Tribunais de Contas e Judiciais sobre licitacoes e contratos administrativos.',
