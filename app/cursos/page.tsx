    ...
    <main className="py-12">
      <div className="container mx-auto px-4">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="bg-brand-50 border-l-4 border-brand-600 p-8 mb-12 rounded-[6px]">
          ...
          <div className="grid gap-8">
            {courses.map((course, index) => {
              ...
              return (
                <div key={course.id} className={`bg-white rounded-[6px] overflow-hidden hover: transition-all border-2 ${color.border} hover:scale-[1.01]`}>
                  <div className="md:flex">
                    <div className={`md:w-1/4 ${color.gradient} p-8 flex items-center justify-center`}>
                    ...
                    <div className="md:w-3/4 p-8">
                      ...
                      <div className={`${color.bg} p-4 rounded-[6px] mb-6 border-l-4 ${color.border}`}>
                        <h3 className="font-bold mb-2 text-ink-primary">Conteúdo do Curso:</h3>
                        <p className="text-ink-secondary line-clamp-3 leading-relaxed">
                          {course.description}
                        </p>
                      </div>

                      <div className="grid md:grid-cols-3 gap-4 mb-6">
                        <div className={`flex items-center gap-2 text-sm font-medium ${color.bg} px-3 py-2 rounded-[6px]`}>
                      ...
                      <Link
                        ...
                        className={`inline-flex items-center gap-2 ${color.gradient} text-white px-8 py-4 rounded-[6px] font-bold hover: transition-all transform hover:-translate-y-0.5`}
                      >
          ...
          <div className="mt-12 relative overflow-hidden">
            ...
            <div className="relative p-10 md:p-12 text-center rounded-[6px]">
              ...
              <Link
                href="/contato"
                className="inline-flex items-center gap-3 bg-white text-ink-primary px-12 py-5 rounded-[6px] text-xl font-bold hover:bg-surface-raised transition-all hover:scale-105 border border-border-subtle"
