...
export async function GET(
  ...
  try {
    ...
    // Formatar resposta no mesmo formato que Document para compatibilidade com DocumentDetails
    const formattedResponse = {
      ...
      summary: act.summary,
      content: act.content,
      // URL para visualização - priorizar officialUrl
      ...
      isPublic: true,
      // Campos para compatibilidade com DocumentDetails
      keyPoints: null,
      tags: '[]',
      courseId: null,
