            ...
            <div className="relative z-10">
              ...
              <form className="flex flex-col sm:flex-row gap-4 max-w-xl mx-auto bg-white/10 backdrop-blur-md p-2 rounded-2xl border-2 border-white/30">
                <input
                  ...
                  aria-label="Digite seu e-mail para receber novos artigos"
                  required
                ...
                <button
                  ...
                  className="bg-gradient-to-r from-green-400 to-teal-500 text-gray-900 px-10 py-4 rounded-xl text-lg font-bold hover:from-green-500 hover:to-teal-600 transition-all hover:scale-105 shadow-xl whitespace-nowrap"
                >
                  Inscrever-se
                </button>
              </form>
