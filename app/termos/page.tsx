...
export const metadata: Metadata = {
  title: 'Termos de Uso | Site do Prof. Daniel Barral',
      ...
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto">
          <header className="mb-10">
            ...
            <div className="h-1 w-32 bg-surface-raised rounded-full mb-4" />
            <p className="text-sm text-ink-muted font-poppins">
              Última atualização: {LAST_UPDATED}
            </p>
          </header>

          <article className="bg-surface-page rounded-md p-8 md:p-10 border border-border-subtle font-poppins text-ink-primary leading-relaxed">
