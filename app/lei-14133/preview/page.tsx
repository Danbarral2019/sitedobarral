 ...
 * - Texto do artigo selecionado renderizado via <ArticleFull> (tipografia jurídica)
 * - Documentos: Top 5 destaques (cards) + lista completa por categoria (accordion)
 *
 * Uma vez aprovado, esta página vira /lei-14133 (público) e a versão equivalente
 * (com Favoritos/Histórico) substitui /area-restrita/lei-comentada.
 */
...
function PreviewContent() {
  ...
  const handleSelectArticle = (article: LeiArticle) => {
    ...
    router.push(`/lei-14133/preview?artigo=${article.numero}`, { scroll: false });
  };
