  ...
  return (
    <div className="min-h-screen bg-brand-50 py-16 px-4">
      <div className="max-w-2xl mx-auto">
        ...
        <Link
          href="/"
          className="inline-flex items-center gap-2 text-ink-muted hover:text-ink-primary mb-8 transition-colors"
        >
          <ArrowLeft className="w-4 h-4" />
          Voltar para o site
        </Link>

        <div className="bg-white rounded-[6px] border-2 border-border-subtle p-8 md:p-12">
          {isSuccess ? (
            // Mensagem de Sucesso
            <div className="text-center">
              ...
              <Link
                href="/"
                className="inline-flex items-center gap-2 bg-primary-600 text-white px-6 py-3 rounded-[6px] font-semibold hover:bg-primary-700 transition-colors"
              >
                Voltar para o Site
              </Link>
            </div>
            ...
            <>
              ...
              {error && (
                <div className="bg-red-50 border-2 border-red-500 rounded-[6px] p-4 mb-6">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div>
                  <label htmlFor="email" className="block text-sm font-semibold text-ink-secondary mb-2">
                    E-mail cadastrado
                  </label>
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-12 pr-4 py-4 rounded-[6px] border-2 border-border-subtle focus:outline-none focus:border-red-500 text-ink-primary disabled:opacity-50 disabled:cursor-not-allowed"
                    />
                  </div>
                </div>

                <div className="bg-amber-accent-soft border-2 border-amber-accent-soft rounded-[6px] p-4">
                  <p className="text-sm text-amber-accent-deep">
                    <strong>Atenção:</strong> Ao cancelar sua inscrição, você não receberá mais:
                  </p>
                  <ul className="mt-2 space-y-1 text-sm text-amber-accent-deep list-disc list-inside">
