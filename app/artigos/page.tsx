  ...
  return (
    <main className="min-h-screen bg-surface-raised">
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="flex items-center gap-4 mb-6">
            ...
            <div>
              ...
              <p className="text-xl text-brand-100">Nova Lei de Licitações e Contratos</p>
            </div>
          </div>
          ...
          <div className="mt-6">
            <a
              ...
              className="inline-flex items-center gap-2 px-5 py-2.5 bg-white/20 text-white rounded-[6px] font-semibold hover:bg-white/30 transition-all text-sm"
            >
      ...
      <div className="max-w-6xl mx-auto px-4 py-8">
        ...
        {/* Loading / Resultados */}
        {showSkeleton ? (
          <div className="bg-white rounded-[6px] border-2 border-border-subtle p-8"aria-busy="true">
            <div className="animate-pulse space-y-4">
              <div className="h-6 w-1/3 bg-surface-deep rounded" />
              <div className="h-12 w-full bg-surface-deep rounded-[6px]" />
              <div className="space-y-3 pt-4">
                {[...Array(6)].map((_, i) => (
                  <div key={i} className="h-20 bg-surface-deep rounded-[6px]" />
                ))}
              </div>
            </div>
          </div>
        ) : hasSearch ? (
          <div className="bg-white rounded-[6px] border-2 border-border-subtle p-8">
            ...
            {searchResults.length === 0 ? (
              <div className="text-center py-12">
                ...
                <p className="text-ink-muted text-lg mb-2">Nenhum artigo encontrado</p>
                ...
                {searchResults.map(article => (
                  ...
                  >
                    <div className="flex items-start gap-4">
                      <div className="flex-shrink-0 w-16 h-16 bg-brand-100 rounded-[6px] flex items-center justify-center text-brand-700 font-bold text-lg group-hover:bg-brand-200 transition-colors">
                        {formatArticleNumber(article.numero)}
                      </div>
                      <div className="flex-1">
                        <div className="text-sm text-ink-muted mb-1">{article.capitulo}</div>
          ...
          <>
            {/* Tabs de Navegação */}
            <div className="flex items-center gap-4 mb-6 bg-white rounded-[6px] p-2 border-2 border-border-subtle">
              <button
                onClick={() => setMode('articles')}
                className={`flex-1 flex items-center justify-center gap-2 px-6 py-3 rounded-[6px] font-bold transition-all ${
                  mode === 'articles'
                ...
                <div className="mb-6">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-12 pr-12 py-3 border-2 border-border-subtle rounded-[6px] focus:ring-2 focus:ring-brand-500 focus:border-transparent"
                    />
                    {articleSearch && (
                      <button
                  ...
                  (() => {
                    ...
                    return (
                      <div>
                        ...
                        <div className="bg-brand-50 rounded-[6px] p-6 mb-6 border-2 border-brand-200">
                          <div className="flex items-start gap-4">
                            <div className="w-12 h-12 bg-brand-600 rounded-[6px] flex items-center justify-center text-2xl flex-shrink-0">
                              {group.icon}
                            </div>
                            <div className="flex-1">
                        ...
                        <div className="space-y-3">
                          {group.articles.map(numero => {
                            ...
                            return (
                              ...
                              >
                                <div className="flex items-start gap-4">
                                  <div className="flex-shrink-0 w-14 h-14 bg-brand-100 rounded-[6px] flex items-center justify-center text-brand-700 font-bold group-hover:bg-brand-200 transition-colors">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    {LEI_14133_GRUPOS.map(group => (
                      <button
                        ...
                        className="text-left p-6 bg-surface-raised rounded-[6px] border-2 border-border-subtle hover:border-brand-500 hover:bg-brand-50 hover: transition-all group"
                      >
                        <div className="flex items-start gap-4 mb-3">
                          <div className="w-12 h-12 bg-brand-100 rounded-[6px] flex items-center justify-center text-2xl group-hover:bg-brand-200 transition-colors flex-shrink-0">
                            {group.icon}
                          </div>
