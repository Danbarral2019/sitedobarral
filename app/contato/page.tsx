        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="md:col-span-2">
              <div className="bg-white rounded-[6px] p-8 border-2 border-border-subtle hover:border-brand-400 hover: transition-all">
                ...
                {isSubmitted ? (
                  <div role="alert" className="bg-brand-50 border-2 border-brand-500 rounded-[6px] p-8 text-center">
                    ...
                    <p className="text-ink-secondary text-lg font-medium">Retornaremos em breve pelo e-mail informado.</p>
                  </div>
                ) : (
                  <form onSubmit={handleSubmit} className="space-y-6">
                    <div className="grid md:grid-cols-2 gap-6">
                      <div>
                        ...
                        <input
                          ...
                          className="w-full px-4 py-2 border-2 border-border-subtle rounded-[6px] focus:ring-2 focus:ring-primary-500 focus:border-primary-600 text-ink-primary"
                        />
                      </div>
                    ...
                    <div className="grid md:grid-cols-2 gap-6">
                      <div>
                        ...
                        <input
                          ...
                          className="w-full px-4 py-2 border-2 border-border-subtle rounded-[6px] focus:ring-2 focus:ring-primary-500 focus:border-primary-600 text-ink-primary placeholder:text-ink-muted"
                        />
                      </div>
                    ...
                    <button
                      ...
                      className="w-full bg-brand-700 text-white px-6 py-4 rounded-[6px] text-lg font-bold hover:from-brand-700 hover:to-brand-800 transition-all hover:scale-105 flex items-center justify-center gap-2 hover: disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:scale-100 border border-border-subtle"
                    >
                      {isSubmitting ? (
                        <>
            ...
            <div className="md:col-span-1 space-y-6">
              ...
              <div className="bg-white rounded-[6px] p-6 border-2 border-border-subtle hover:border-brand-400 hover: transition-all">
                <div className="inline-block mb-4">
                  <h3 className="text-lg font-bold mb-2 text-ink-primary">Informações de Contato</h3>
                  <div className="h-1 w-16 bg-brand-600 rounded-full"></div>
                </div>
                <div className="space-y-4">
                  <div className="flex items-start gap-3 bg-brand-100 p-3 rounded-[6px] border-l-4 border-brand-500">
                    <div className="w-10 h-10 bg-brand-700 rounded-[6px] flex items-center justify-center flex-shrink-0">
                      <Mail className="w-5 h-5 text-white" />
                    </div>
                    <div>
                      <p className="font-bold text-ink-primary">E-mail</p>
                      <p className="text-sm text-ink-secondary font-medium">contato@profbarral.com.br</p>
                    </div>
                  </div>

                  <div className="flex items-start gap-3 bg-green-100 p-3 rounded-[6px] border-l-4 border-green-500">
                    <div className="w-10 h-10 bg-green-700 rounded-[6px] flex items-center justify-center flex-shrink-0">
                      <Phone className="w-5 h-5 text-white" />
                    </div>
                    <div>
                      <p className="font-bold text-ink-primary">Telefone</p>
                      <p className="text-sm text-ink-secondary font-medium">(71) 99999-9999</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3 bg-brand-100 p-3 rounded-[6px] border-l-4 border-brand-500">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-ink-secondary font-medium">Salvador - BA</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white rounded-[6px] p-6 border-2 border-border-subtle hover:border-brand-400 hover: transition-all">
                ...
                <div className="space-y-3">
                  <a
                    ...
                    className="flex items-center gap-3 bg-brand-50 p-3 rounded-[6px] border-l-4 border-brand-500 hover: transition-all group"
                  >
                    <div className="w-10 h-10 bg-brand-600 rounded-[6px] flex items-center justify-center group-hover:scale-110 transition-transform">
                  ...
                  <a
                    ...
                    className="flex items-center gap-3 bg-red-50 p-3 rounded-[6px] border-l-4 border-red-600 hover: transition-all group"
                  >
                    <div className="w-10 h-10 bg-red-700 rounded-[6px] flex items-center justify-center group-hover:scale-110 transition-transform">
                  ...
                  <a
                    ...
                    className="flex items-center gap-3 bg-brand-50 p-3 rounded-[6px] border-l-4 border-brand-700 hover: transition-all group"
                  >
                    <div className="w-10 h-10 bg-brand-800 rounded-[6px] flex items-center justify-center group-hover:scale-110 transition-transform">
