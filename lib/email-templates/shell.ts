    ...
    <table width="100%" cellpadding="0" cellspacing="0" border="0" style="background:#20364e;">
      <tr>
        <td align="center" style="padding:0;">
          <!--[if mso]>
          <table width="600" cellpadding="0" cellspacing="0" border="0"><tr><td style="background-color:#20364e;padding:36px 30px;">
          <![endif]-->
          <!--[if !mso]><!-->
          ...
          <!--<![endif]-->
                ...
                <p style="margin:12px 0 0 0;font-size:14px;color:#eeeae4;font-family:Arial,Helvetica,sans-serif;letter-spacing:0.3px;">Direito Administrativo, Licita&#231;&#245;es e Contratos</p>
          <!--[if mso]>
          </td></tr></table>
          <![endif]-->
          <!--[if !mso]><!-->
...
export function renderFooter(): string {
  return `
    <table width="100%" cellpadding="0" cellspacing="0" border="0" style="background-color:#142230;">
      <tr>
        <td align="center" style="padding:28px 20px 14px 20px;">
          <p style="margin:0 0 6px 0;font-size:15px;color:#f7f6f3;font-family:Georgia,'Times New Roman',serif;font-weight:700;">Prof. Daniel Barral</p>
          <p style="margin:0 0 14px 0;font-size:12px;color:#cdcac4;font-family:Arial,Helvetica,sans-serif;">Direito Administrativo, Licita&#231;&#245;es e Contratos</p>
          <table cellpadding="0" cellspacing="0" border="0">
            <tr>
              <td align="center" style="padding:0 8px;">
                <a href="https://www.linkedin.com/in/daniel-de-andrade-oliveira-barral-b5110870/" style="color:#e9d8b8;text-decoration:none;font-size:12px;font-family:Arial,Helvetica,sans-serif;">LinkedIn</a>
              </td>
              <td style="color:#3d4044;font-size:12px;">|</td>
              <td align="center" style="padding:0 8px;">
                <a href="https://instagram.com/danbarral" style="color:#e9d8b8;text-decoration:none;font-size:12px;font-family:Arial,Helvetica,sans-serif;">Instagram</a>
              </td>
              <td style="color:#3d4044;font-size:12px;">|</td>
              <td align="center" style="padding:0 8px;">
                <a href="${baseUrl}" style="color:#e9d8b8;text-decoration:none;font-size:12px;font-family:Arial,Helvetica,sans-serif;">Site</a>
              </td>
            </tr>
          </table>
        </td>
      ...
      <tr>
        <td align="center" style="padding:14px 20px 20px 20px;">
          <p style="margin:0 0 6px 0;font-size:11px;color:#cdcac4;font-family:Arial,Helvetica,sans-serif;line-height:1.5;">
            Este &#233; um email transacional referente &#224; sua assinatura.
          </p>
          <p style="margin:0;font-size:11px;color:#cdcac4;font-family:Arial,Helvetica,sans-serif;">
...
export function renderButton(text: string, href: string): string {
  return `
    <table cellpadding="0" cellspacing="0" border="0" style="margin:24px auto;">
      <tr>
        <td align="center" style="border-radius:6px;background:#20364e;">
          <!--[if mso]>
          <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="${href}" style="height:44px;v-text-anchor:middle;width:240px;" arcsize="14%" stroke="f" fillcolor="#20364e">
            <w:anchorlock/>
            <center style="color:#ffffff;font-family:Arial,Helvetica,sans-serif;font-size:15px;font-weight:700;">${text}</center>
          </v:roundrect>
          <![endif]-->
          <!--[if !mso]><!-->
          <a href="${href}" style="background:#20364e;border-radius:6px;color:#ffffff;display:inline-block;font-family:Arial,Helvetica,sans-serif;font-size:15px;font-weight:700;line-height:44px;text-align:center;text-decoration:none;width:240px;mso-hide:all;">${text}</a>
          <!--<![endif]-->
        </td>
      </tr>
    </table>`;
  ...
  <tr>
    <td align="center" style="padding:0;">
      <table width="600" cellpadding="0" cellspacing="0" border="0" style="max-width:600px;background-color:#ffffff;">
        ...
        <tr>
          <td style="padding:32px 32px 8px 32px;font-family:Arial,Helvetica,sans-serif;color:#1a1c20;font-size:15px;line-height:1.6;">
            ${contentHtml}
          </td>
        </tr>
